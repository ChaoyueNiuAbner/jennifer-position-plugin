...
namespace gazebo
{
  ...
  class PexodPlugin : public ModelPlugin
  {
    ...
    public: virtual void Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
    {
        ...
        // Leg 1
        this->pid_leg1 = common::PID(1.0, 0, 0);
        // Leg 2
        this->pid_leg2 = common::PID(1.0, 0, 0);
        // Leg 3
        this->pid_leg3 = common::PID(1.0, 0, 0);
        // Leg 4
        this->pid_leg4 = common::PID(1.0, 0, 0);
        // Leg 5
        this->pid_leg5 = common::PID(1.0, 0, 0);
        // Leg 6
        this->pid_leg6 = common::PID(1.0, 0, 0);
